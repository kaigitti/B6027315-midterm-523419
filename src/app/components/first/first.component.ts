...
export class FirstComponent implements OnInit {
  ...
  constructor() {
    this.profile = {
      studentid: 'B6027315',
      name: 'Kaigitti Nimitpant',
      gender: 'Male',
      birthyear: 1998,
      email: 'b6027315@gmail.com',
      phone: '091-xxxxxxx',
  ...
  // showAddress(){
  //   window.alert('SUT 111 University Avenue, Suranaree Sub-Distric, Muang Nakhon Ratchasima Distric, Nakhon Ratchasima 30000 Thailand');
  // }
